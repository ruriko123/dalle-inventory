...
class IntblItems(models.Model):
    ...
    stocktype = models.CharField(db_column='StockType', max_length=15, blank=True, null=True)  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'intbl_items'


class Intblstorereqdetails(models.Model):
    idintblstorereqdetails = models.AutoField(db_column='idintblStoreReqDetails', primary_key=True)  # Field name made lowercase.
    itemid = models.ForeignKey(IntblItems, models.DO_NOTHING, db_column='ItemID', blank=True, null=True)  # Field name made lowercase.
    storereqid = models.ForeignKey('Intblstorerequisition', models.DO_NOTHING, db_column='StoreReqID', blank=True, null=True)  # Field name made lowercase.
    amount = models.DecimalField(db_column='Amount', max_digits=10, decimal_places=3, blank=True, null=True)  # Field name made lowercase.
    uom = models.CharField(db_column='UOM', max_length=50, blank=True, null=True)  # Field name made lowercase.
    rate = models.DecimalField(db_column='Rate', max_digits=10, decimal_places=2, blank=True, null=True)  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'intblstorereqdetails'


class Intblstorerequisition(models.Model):
    idintblstorerequisition = models.AutoField(db_column='idintblStoreRequisition', primary_key=True)  # Field name made lowercase.
    ...
    destinationstore = models.CharField(db_column='DestinationStore', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'intblstorerequisition'
